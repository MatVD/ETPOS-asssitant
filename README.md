...
Baseline déterministe actuelle du corpus actif au 19 septembre 2026, avec `K=5` et 47 cas : **44 cas répondables**, Recall@5 **100,0 %**, MRR **0,896** et couverture des groupes **100,0 %**. Le corpus contient **3 documents / 273 sections** : manuel ETPOS V5.34, 10 FAQ Support et l'actualité officielle Verifone. Sur `eval/acceptance.jsonl`, **13 cas répondables** obtiennent Recall@5 **100,0 %**, MRR **0,692** et couverture **100,0 %**. Après l'extension conversationnelle, `eval/challenge.jsonl` atteint sur **49 cas répondables** Recall@5 **100,0 %**, MRR **0,809** et couverture des groupes **100,0 %** : formulations naturelles, fautes de frappe, raccourcis, ambiguïtés, multi-intentions, suivis conversationnels et questions partielles atteignent tous **100 % de Recall@5** ; les cinq cas multi-intentions couvrent également **100 %** de leurs groupes documentaires attendus. Le contrat `eval/support.jsonl` conserve Recall@5 et couverture **100,0 %** sur ses 10 FAQ, avec MRR **0,643** ; ce MRR inférieur à l'ancienne baseline vient du fait que certaines expansions métier font désormais passer des sections détaillées du manuel devant la FAQ correspondante, sans faire sortir la source Support du top 5. `eval/news.jsonl` reste à Recall@5 et couverture **100,0 %**, MRR **0,667**. Les cas qui demandent une information actuelle absente de la documentation, mais pour lesquels la documentation fournit tout de même une information ETPOS utile, sont classés `partial` plutôt que `none`.
