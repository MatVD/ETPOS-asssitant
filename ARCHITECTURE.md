...
La seconde couche, `eval-answer`, utilise le provider Codex et réemploie le même retrieval, le même prompt et la même finalisation de réponse/citations que le chat de production. Elle mesure de manière déterministe : abstention correcte, couverture des faits obligatoires, exactitude des chemins de menus attendus, présence des citations, pertinence des citations et latence de réponse complète. L'abstention complète utilise une réponse canonique afin de pouvoir être scorée sans juge LLM.
